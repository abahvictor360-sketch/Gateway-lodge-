...
function gwl_nrp_custom_css() {
	$rule = "/* GWL-START */\n"
		...
		. "   off mid-row. Note that overflow-x alone is not safe here: when one axis\n"
		. "   is set to something other than visible, the used value of the other\n"
		. "   becomes auto, which is what clipped it. */\n"
		. ".gwl-booking-panel,\n"
		. ".gwl-booking-panel > .e-con-inner,\n"
		. ".gwl-booking-panel .elementor-widget-html,\n"
		. ".gwl-booking-panel .elementor-widget-container,\n"
		. ".gwl-booking-panel .Configure-quickBook-Widget { overflow: visible; }\n"
		. "\n"
