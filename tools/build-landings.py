...
PROPERTIES = [
    {
        ...
        "gallery": [
            ...
            ("media/lounge-dining.jpg", "Living room with the dining table in the foreground at Gateway Nova Ridge"),
            ("media/bedroom-wardrobe.jpg", "Bedroom with fitted wardrobes at Gateway Nova Ridge"),
            ("media/bathroom-two.jpg", "Dining table and armchair beside the living room window at Gateway Nova Ridge"),
        ],
        "location_points": [
    ...
    },
    {
        ...
        "gallery": [
            ...
            ("media/living-wide.jpg", "Living room looking through to the dining area at Gateway Lodge Lakeside"),
            ("media/living-seating.jpg", "Seating around the coffee table at Gateway Lodge Lakeside"),
            ("media/living-corner.jpg", "Sofas facing the television wall at Gateway Lodge Lakeside"),
            ("media/living-dining.jpg", "Open living and dining area at Gateway Lodge Lakeside"),
            ("media/living-curtains.jpg", "Curtained window bay in the living room at Gateway Lodge Lakeside"),
            ("media/lounge-kitchen.jpg", "Dining table beside the kitchen at Gateway Lodge Lakeside"),
            ("media/workspace.jpg", "Breakfast bar in the open-plan living room at Gateway Lodge Lakeside"),
            ("media/kitchen-gloss.jpg", "Fitted kitchen with oven and washing machine at Gateway Lodge Lakeside"),
            ("media/kitchen-open.jpg", "Kitchen worktop and cabinetry at Gateway Lodge Lakeside"),
            ("media/bedroom-window.jpg", "Bedroom with full-height curtains at Gateway Lodge Lakeside"),
            ("media/hallway.jpg", "Hallway through to the dining area at Gateway Lodge Lakeside"),
            ("media/corridor.jpg", "Walkway between the apartments at Gateway Lodge Lakeside"),
            ("media/entrance-gate.jpg", "Gated entrance and paved forecourt at Gateway Lodge Lakeside"),
        ],
        "location_points": [
    ...
    },
    {
        ...
        "gallery": [
            ...
            ("media/living-seating.jpg", "Armchairs and sofas beneath the chandelier at Gateway Lodge Tamale"),
            ("media/bedroom-second.jpg", "Second bedroom with blue drapes at Gateway Lodge Tamale"),
            ("media/bedroom-window.jpg", "Bedroom with curtained windows on two walls at Gateway Lodge Tamale"),
            ("media/kitchen-laundry.jpg", "Kitchen units, sink and washing machine at Gateway Lodge Tamale"),
            ("media/bathroom-shower.jpg", "Walk-in glass shower and basin at Gateway Lodge Tamale"),
